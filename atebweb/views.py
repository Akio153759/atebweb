...
def index (request):   
    try:
        ...
        partidos = Partido.objects.select_related('equipo1','equipo2','fecha').filter(fecha=ultima_fecha).values('fecha', 'equipo1__abreviacion','equipo1__logo_equipo','equipo2__abreviacion','equipo2__logo_equipo', 'fecha_partido')
